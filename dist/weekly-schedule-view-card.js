(function () {
  ...
  class WeeklyScheduleViewCard extends WeeklyScheduleBase {
    ...
    `;
      ...
      this.shadowRoot.querySelector('.toggle-btn')?.addEventListener('click', () => this._cycleLayout());
      this.shadowRoot.querySelector('.vc-new-profile')?.addEventListener('click', () => this._showNewProfileDialog());
      this.shadowRoot.querySelector('.vc-manage-groups')?.addEventListener('click', () => this._renderGroupsView());

      this.shadowRoot.querySelectorAll('.prof-chip').forEach(el => {
      ...
      this.shadowRoot.querySelectorAll('.tab-chip').forEach(el => {
      ...
      this.shadowRoot.querySelectorAll('.focus-col-body').forEach(el => {
        el.addEventListener('click', e => {
      ...
      this.shadowRoot.querySelectorAll('.compact-bar').forEach(el => {
        el.addEventListener('click', e => {
          if (e.target.closest('[data-entity]')) return;
          const rect = el.getBoundingClientRect();
          ...
          const ec = ents[ei]; if (!ec) return;
          this._openCreatePopup(di, clickPct, ec);
        });
      });

      this.shadowRoot.querySelectorAll('.compact-day-hdr').forEach(el => {
        el.addEventListener('click', () => {
          const di = parseInt(el.dataset.day);
      ...
      this.shadowRoot.querySelectorAll('.focus-slim').forEach(el => {
        el.addEventListener('click', () => {
      ...
      this.shadowRoot.querySelector('.status-prof')?.addEventListener('click', e => {
